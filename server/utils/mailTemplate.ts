...
export const emailTemplate = (alertMessage: ALERTS, date: Date) => `
<!DOCTYPE html>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
           <tr>
            <td style="padding: 0px 0px 0px 0px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 40px 40px; background-color: #50b57a;" bgcolor="#50b57a">
                    ...
                    <tr>
                     <td valign="top" align="center">
                      <div class="pc-font-alt" style="text-decoration: none;">
                       <div style="text-align:center;text-align-last:center;color:#ffffff;font-size:36px;letter-spacing:-0.6px;font-weight:800;font-style:normal;font-variant-ligatures:normal;">
                        <div style="margin-bottom: 0px;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; line-height: 128%; text-decoration: none; text-transform: none;" class="pc-w620-font-size-30px pc-w620-line-height-133pc">MonsterPot Alert</span>
                        </div>
                       </div>
                      </div>
                     </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="center" valign="top" style="padding: 0px 0px 30px 0px;">
                   <img src="https://cloudfilesdm.com/postcards/image-1735465362209.png" width="200" height="334" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 200px; height: auto; max-width: 100%; border: 0;" />
                  </td>
                 </tr>
                </table>
               </td>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
              <tr>
               <td valign="top" class="pc-w520-padding-30-30-30-30 pc-w620-padding-35-35-35-35" style="padding: 40px 40px 40px 40px; border-radius: 0px; background-color: #ffffff;" bgcolor="#ffffff">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                  <td align="left" valign="top" style="padding: 0px 0px 13px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="left">
                      <div class="pc-font-alt" style="text-decoration: none;">
                       <div style="color:#40be65;font-size:14px;letter-spacing:-0.2px;font-weight:500;font-style:normal;font-variant-ligatures:normal;">
                        <div style="margin-bottom: 0px;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; line-height: 17px; text-decoration: none; text-transform: none;">${getFormattedDate(date.toISOString())}</span>
                        </div>
                       </div>
                      </div>
                     </td>
                    ...
                    <tr>
                     <td valign="top" align="left">
                      <a class="pc-font-alt" href="https://postcards.email/" target="_blank" style="text-decoration: none;">
                       <div style="color:#151515;font-size:24px;letter-spacing:-0.4px;font-weight:700;font-style:normal;font-variant-ligatures:normal;">
                        <div style="margin-bottom: 0px;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; line-height: 34px; text-decoration: none; text-transform: none;">${alertMessage}</span>
                        </div>
                       </div>
                      </a>
                     </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                 <tr>
                  <td valign="top" align="left">
                   <a class="pc-font-alt" href="https://postcards.email/" target="_blank" style="text-decoration: none;">
                    <div style="color:#ed5653;font-size:18px;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                     <div style="margin-bottom: 0px;"><span style="font-family: 'Fira Sans', Arial, Helvetica, sans-serif; line-height: 28px; text-decoration: none; text-transform: none;">Wymagane działanie od użytkownika</span>
                     </div>
                    </div>
                   </a>
                  </td>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
           <tr>
            <td align="center" valign="top" style="padding-top: 20px; padding-bottom: 20px; vertical-align: top;">
             <a href="https://postcards.email/?uid=Mjg0MjE3&type=footer" target="_blank" style="text-decoration: none; overflow: hidden; border-radius: 2px; display: inline-block;">
             ...
             <img src="https://api-postcards.designmodo.com/tracking/mail/promo?uid=Mjg0MjE3" width="1" height="1" alt="" style="display:none; width: 1px; height: 1px;">
            </td>
           </tr>
          </table>
         </td>
